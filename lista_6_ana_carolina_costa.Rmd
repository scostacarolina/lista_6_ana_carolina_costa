...
summary(reg.11)
```
* Em relação a significância estatística o modelo completo da questão 10 apresenta um p valor menor que o do modelo filtrado entre os anos 1876-1932.Logo, o modelo da questão 11 é mais proximo do padrão estatístico de 0,5. E moderadamente mais significativo estatísticamente. 

* Em relação ao intervalo de confiança o modelo completo da questão 10 apresenta um intervalo de confiançaa menor que o do modelo filtrado entre os anos 1876 - 1932

* Em relação a medida de ajuste de modelo, no modelo completo da questão 10 houve um crescimento das estimativas, enquanto no modelo filtrado houve uma diminuição das estimativas. O que sugere um menor resíduo amostral no modelo filtrado. 