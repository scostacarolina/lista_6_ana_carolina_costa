...
## c) Apresente qual a relaÃ§Ã£o existente entre variaveis independentes ##
## e dependente: ## 
...
## beta -> trata-se do  coeficiente de variaçao 
...
## como já dito Y¹ e a variavel dependente explicada, enquanto ^Y¹ é o valor 
...
## conseguem trabalhar com o todo populacional. Quando ha a presença de valores 
...
## de otimização matematica que procura encontrar o melhor ajuste para uma 
...
## utílize "##" após um código para fazer um comentario curto. 
...
# h) documentação da funcao;
# e interessante que haja comentarios logo apos o comando da função, explicando
...
# e mais dificil visualisar a diferença na distribuicao pois as contagens gerais 
...
# A grande sacada é que graficos bidimensionais revelam outliers que nao sao 
...
# compare quanto ao modelo completo do exercício 10 em relação a:
...
# Logo, o modelo da questão 11 e mais proximo do padrao estatistico de 0,5
# e moderadamente mais significativo estatisticamente

# Em relacao ao intervalo de confianca o modelo completo da questao 10 
# apresenta um intervalo de confianca menor que o do modelo filtrado 

# Em relacao a medida de ajuste de modelo, no modelo completo da questao 10
# houve um crescimento das estimativas, enquanto no modelo filtrado houve uma 
# diminuicao das estimativas. O que sugere um menor residuo amostral no modelo
# filtrado. 